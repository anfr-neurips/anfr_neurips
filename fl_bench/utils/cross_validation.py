...
class CrossSiteModelEval(Controller):
    def __init__(
        ...
        Args:
            ...
            model_choice (str, optional): Whether to evaluate the best or the last models
            of each client. Defaults to 'last'.
        ...
        if model_choice not in ["best", "last"]:
            raise TypeError("model_choice must be either best or last but got {}".format(model_choice))
