...
def main():
    ...
    parser.add_argument("--grad_clipping_type", type=str, default="norm", choices=["none", "norm", "agc"])
    ...
    parser.add_argument("--train_split_root", type=str, default="")
    ...
    model_path = f"fl_bench.networks.colon_nets.{args.model_name}"
    ...
    if args.method == "scaffold":
        ...
        server_config["components"][5]["args"]["expected_data_kind"] = {
        ...
        server_config["task_result_filters"] = []
        for i in [4, 5]:
            if server_config['components'][i]['id'] == 'aggregator':
                server_config['components'][i]['args']['expected_data_kind'] = "WEIGHT_DIFF"
    ...
    if args.method == "fedattn" or args.method == "fedper":
        ...
        server_config["components"][5]["args"]["exclude_vars"] = ""
    ...
    job_name += f"_colon_{args.method}"
    # update seed
